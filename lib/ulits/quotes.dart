List sweetsayings = [
  "your pressesncs , lights up the whole room",
  "we admire , your strong personnality ",
  "we'll help you in any wway we can",
  "you are striong and courageous ",
  "I say if im beautifull . i say i'm staring",
  "above all , be the heroin of you life",
];
